      ...
      <div className="max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-2 md:flex-row">
        <div className="flex flex-col justify-center h-full">
          ...
          <p className="text-gray-500 py-4 max-w-md">
            ...
            sequi nesciunt adipisci quos quibusdam non aliquid, beatae, sit
            similique delectus, neque distinctio. Deleniti odio ducimus,
            doloribus non optio asperiores corporis.
          </p>
